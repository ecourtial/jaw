 ...
 */
final class Version20220425085418 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE posts ADD created_at DATETIME NOT NULL, ADD updated_at DATETIME NOT NULL');
    }
